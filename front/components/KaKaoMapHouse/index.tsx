...
const KaKaoMapHouse = () => {
    ...
    const [mapCenter, setCenter] = useState([37.531427643208275, 127.0619991033721]);
    ...
    useEffect(()=> {
        ...
        console.log("center 1 = ", mapCenter[0]);
        console.log("center 2 = ", mapCenter[1]);
        ...
        window.kakao.maps.event.addListener(map, 'center_changed', function () {
            ...
            let a = Number(center['Ma']);
            console.log("a = ", a);

            let b = Number(center['La']);
            console.log("b = ", b);

            setCenter(center);

            geocoder.coord2RegionCode(b, a, function (result: any, status: any) {
        ...
        // };
        // console.log("center?? = ", mapCenter);
        // geocoder.coord2RegionCode(mapCenter[0], mapCenter[1], callback);
